        ...
        <Carousel>
          ...
          {!isMobile && (
            <div className="relative">
              ...
              <div className="absolute inset-y-0 left-0 w-4 bg-gradient-to-r from-background" />
              <div className="absolute inset-y-0 right-0 w-4 bg-gradient-to-l from-background" />
            </div>
          )}
        </Carousel>
      ) : null}
